    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-20 items-center justify-between">
          <Link
            to="/"
            className="flex items-center gap-2 text-2xl font-bold text-orange-500 transition-opacity hover:opacity-80 dark:text-orange-400"
          >
          ...
          <div className="flex items-center gap-8">
            <Link
              to="/"
              className="font-medium transition-colors hover:text-orange-500 dark:hover:text-orange-400"
            >
              Inicio
            </Link>
            <Link
